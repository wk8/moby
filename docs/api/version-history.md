...
* `GET /services` now returns `MemorySwap` and `MemorySwappiness` as part of the `ContainerSpec`.
* `GET /services/{id}` now returns `MemorySwap` and `MemorySwappiness` as part of the `ContainerSpec`.
* `POST /services/create` now accepts `MemorySwap` and `MemorySwappiness` as part of the `ContainerSpec`.
* `POST /services/{id}/update` now accepts `MemorySwap` and `MemorySwappiness` as part of the `ContainerSpec`.
* `GET /tasks` now  returns `MemorySwap` and `MemorySwappiness` as part of the `ContainerSpec`.
* `GET /tasks/{id}` now  returns `MemorySwap` and `MemorySwappiness` as part of the `ContainerSpec`.
